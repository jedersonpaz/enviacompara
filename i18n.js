...
const TRADUCCIONES = {
  es: {
    ...
    buscando: "Buscando...",
    investigando_en_vivo: "Investigando en vivo...",
    encontrado_ahora: "Encontrado ahora mismo, investigado en vivo",
    ...
    sin_resultados_2: "Por ahora cubrimos: México ↔ Colombia, México ↔ Perú, Turquía → México, México ↔ España, Colombia ↔ Perú, Argentina ↔ Chile, Ecuador → Colombia, Colombia → Venezuela, Brasil → Argentina, México → Venezuela, Alemania → Francia, Colombia → Ecuador. Tu búsqueda quedó guardada — la estamos agregando pronto.",
    ...
    footer_buscador: "EnviaCompara — en construcción · empresas reales, cobertura limitada por ahora",
    footer_empresas: "EnviaCompara — panel para empresas",
    resultados_encontradas: "empresas encontradas",
    mejor_precio: "Mejor precio",
    ahorras: "ahorras",
    stats_empresas: "empresas identificadas",
    stats_corredores: "corredores",
    ...
    saludo_hola: "Hola,",
    contacto_recibido_singular: "cliente real te contactó hasta ahora",
    contactos_recibidos_plural: "clientes reales te han contactado hasta ahora",
  ...
  en: {
    ...
    buscando: "Searching...",
    investigando_en_vivo: "Researching live...",
    encontrado_ahora: "Just found, researched live",
    ...
    sin_resultados_2: "Right now we cover: Mexico ↔ Colombia, Mexico ↔ Peru, Turkey → Mexico, Mexico ↔ Spain, Colombia ↔ Peru, Argentina ↔ Chile, Ecuador → Colombia, Colombia → Venezuela, Brazil → Argentina, Mexico → Venezuela, Germany → France, Colombia → Ecuador. Your search was saved — we're adding more soon.",
    ...
    footer_buscador: "EnviaCompara — under construction · real companies, limited coverage for now",
    footer_empresas: "EnviaCompara — business panel",
    resultados_encontradas: "companies found",
    mejor_precio: "Best price",
    ahorras: "you save",
    stats_empresas: "companies identified",
    stats_corredores: "corridors",
    ...
    saludo_hola: "Hello,",
    contacto_recibido_singular: "real customer has contacted you so far",
    contactos_recibidos_plural: "real customers have contacted you so far",
