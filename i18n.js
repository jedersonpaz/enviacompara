...
const TRADUCCIONES = {
  es: {
    ...
    demo_note: "⚠️ Prototipo de validación — los precios y empresas mostrados son <strong>datos de ejemplo</strong>, no tarifas reales en vivo.",
    moneda_vista_label: "Mostrar precios en",
    moneda_vista_nota: "Conversión aproximada de referencia — no son tasas de cambio en vivo.",
  ...
  en: {
    ...
    demo_note: "⚠️ Validation prototype — prices and companies shown are <strong>sample data</strong>, not live rates.",
    moneda_vista_label: "Show prices in",
    moneda_vista_nota: "Approximate reference conversion — not live exchange rates.",
