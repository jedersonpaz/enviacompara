...
const TRADUCCIONES = {
  es: {
    ...
    sin_resultados_2: "Por ahora cubrimos: México ↔ Colombia, México ↔ Perú, Turquía → México, México ↔ España, Colombia ↔ Perú, Argentina ↔ Chile, Ecuador → Colombia, Colombia → Venezuela, Brasil → Argentina. Tu búsqueda quedó guardada — la estamos agregando pronto.",
  ...
  en: {
    ...
    sin_resultados_2: "Right now we cover: Mexico ↔ Colombia, Mexico ↔ Peru, Turkey → Mexico, Mexico ↔ Spain, Colombia ↔ Peru, Argentina ↔ Chile, Ecuador → Colombia, Colombia → Venezuela, Brazil → Argentina. Your search was saved — we're adding more soon.",
